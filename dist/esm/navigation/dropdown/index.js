...
export default (function (_ref) {
  ...
  var _useState = useState(false),
    ...
    open = _useState2[0],
    setopen = _useState2[1]; // 默认不显示
  var _useState3 = useState(style || {}),
  ...
  useEffect(function () {
    if (childrenRef && childrenRef.current) {
      var _childrenRef$current$ = childrenRef.current.getBoundingClientRect(),
        left = _childrenRef$current$.left,
        top = _childrenRef$current$.top,
        height = _childrenRef$current$.height,
        width = _childrenRef$current$.width;
      var _childrenRef$current = childrenRef.current,
        offsetTop = _childrenRef$current.offsetTop,
        offsetLeft = _childrenRef$current.offsetLeft;
      setstyle(
        _objectSpread(
          {
            left: offsetLeft,
